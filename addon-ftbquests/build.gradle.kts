...
dependencies {
    ...
    implementation("curse.maven:ftb-library-forge-404465:7746959")
    implementation("curse.maven:ftb-teams-forge-404468:7878281")
    implementation("curse.maven:ftb-quests-forge-289412:7878289")
}
...
publishMods {
    ...
    val formattedAddonModId = "FTB Quests"
    ...
    curseforge {
        ...
        projectId.set("1565842")
        minecraftVersions.add(minecraft_version)
        changelogType.set("markdown")
        requires("astages", "ftb-quests-forge")

        displayName.set("$mod_id-$mod_version")

        projectSlug.set("astages-ftb-quests") // For discord setup
        announcementTitle.set("Download from CurseForge") // For discord setup
    }

    modrinth {
        accessToken.set(providers.environmentVariable("MODRINTH_API_KEY"))
        projectId.set("WeZ2k3T1")
        minecraftVersions.add(minecraft_version)
        requires("astages"/*, "not-exists"*/)
